...
class LoginFrame(ctk.CTkFrame):
    def __init__(self, *args, auth: Callable, **kwargs):
        ...
        self.lytecord_label = ctk.CTkLabel(self.login_frame, text="Lytecord", font=ctk.CTkFont(size=60, weight="bold"),
                                           anchor="center")
        ...
        self.username_info_label = ctk.CTkLabel(self.login_frame,
                                                text="Username must be at least 3 and at most 20 characters long,\ncontain letters, numbers and '.', '_'.",
                                                text_color="gray", font=('', 12), justify='left')
        ...
        # password info label
        self.password_info_label = ctk.CTkLabel(self.login_frame,
        ...
        self.color_picker = CTkColorPicker(self.login_frame, initial_color="#ffffff", corner_radius=5,
        ...
        self.switch_auth_mode_button = ctk.CTkButton(self.login_frame, text="Signup",
                                                     command=self.switch_authentication_mode)
